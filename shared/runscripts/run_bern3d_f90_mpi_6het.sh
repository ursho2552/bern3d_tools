...
--het-group=3 --partition=icpu-poeppelmeier --ntasks=1 --cpus-per-task=1 --export=all ./$SLURM_JOB_NAME : \
--het-group=4 --partition=icpu-poeppelmeier --ntasks=1 --cpus-per-task=1 --export=all ./$SLURM_JOB_NAME : \
--het-group=5 --partition=epyc2--ntasks=12 --cpus-per-task=1 --export=all ./$SLURM_JOB_NAME > $SLURM_JOB_NAME.out 2>&1
